...
//       Q_PROPERTY(Ms::MScore::DirectionH         userMirror        READ userMirror         WRITE undoSetUserMirror)
   ...
   public:
      ...
      /// \since MuseScore 3.3
      Q_INVOKABLE Ms::PluginAPI::PlayEvent* createPlayEvent() { return playEventWrap<PlayEvent>(new NoteEvent(), this); }
      };
...
class Chord : public Element {
   ...
   public:
      ...
      void setPlayEventType(Ms::PlayEventType v) { chord()->score()->setPlaylistDirty(); chord()->setPlayEventType(v); }
      /// \endcond
      };
